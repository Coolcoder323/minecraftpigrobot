...
This document lists the third-party assets, libraries, and designs utilized in the creation of the Arduino-Powered Minecraft Pig Robot.

## 1. Software Libraries
This project utilizes the following open-source software components:
* **Arduino Servo Library:** Built-in library provided by the Arduino developer community. Used for motor control.
* [Insert Library Name]: Created by coolcoder323. Licensed under the [Insert License Type, e.g., MIT License]. Link: [Insert URL]
